            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between income-wrapper">
                ...
                <div class="table-right-content">
                  <button href="#" class="btn btn-info" data-toggle="modal" data-target="#createbranch" onclick="resetModel()">
            ...
            <div class="card">
              <div class="branch-items row mb-2">
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <select id="session" class="select2 form-control" name="session[]" multiple="multiple" required>
                ...
                <?php } else { ?>
                  <div class="form-group col-md-4 col-sm-12">
                    <div class="form-group">
                      ...
                      <select required class="form-control" name="admin_id" id="admin_id">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <img id="branch_logo" src="" width="90px" required />
              ...
              <div class="branch-items row mb-2">
                ...
                <div class="form-group col-md-4 col-sm-12">
                  ...
                  <input class="form-control" type="text" id="pan_no" name="pan_no" placeholder="Enter Pan No" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">CIN:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="CIN" name="CIN" placeholder="Enter CIN" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">GST No:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="gst_no" name="gst_no" placeholder="Enter GST No" required>
                </div>
              </div>
              <div class="branch-items row mb-2">
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">Bank Name:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="bank_name" name="bank_name" placeholder="Eneter Bank Name" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">Account Holder Name:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="account_name" name="account_name" placeholder="Eneter Holder Name" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">Account No:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="account_no" name="account_no" placeholder="Eneter Account No" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">IFSC No:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="ifsc" name="ifsc" placeholder="Eneter IFSC No" required>
                </div>
                <div class="form-group col-md-4 col-sm-12">
                  <label for="pwd">Account Type:<span style="color: red;">*</span></label>
                  <input class="form-control" type="text" id="account_type" name="account_type" placeholder="Like Saving" required>
                </div>
              </div>
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="card">
            <div class="branch-items row mb-2">
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Receipt Type:<span style="color: red;">*</span></label>
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Branch Logo:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Brnach Address:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Branch Title:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Course<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Receipt No:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Receipt Date:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Gr ID:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Enrollment No:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">GST No:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Fees Paid:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Intsallment No:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Tuition Fees:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Total Pay:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">The Sum Of:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
              ...
              <div class="form-group col-md-4 col-sm-12">
                <div class="form-group">
                  <label class="d-block">Remarks:<span style="color: red;">*</span></label>
                  <div class="pretty p-icon p-jelly p-round p-bigger">
