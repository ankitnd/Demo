                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between income-wrapper">
                        ...
                        <div class="table-right-content">
                           <button href="#" class="btn btn-info" data-toggle="modal" data-target="#createuser">
         ...
         <div class="modal-content">
                     ...
                     <div class="branch-items row mb-2">
                        ...
                        <div class="form-group  col-md-4 col-sm-12">
                           ...
                           <select required class="form-control" name="admin_id" required>
                              ...
                              <option value="65">Mehul Kachhadiya</option>
                           </select>
                        </div>
                     </div>
                  </div>
            ...
            <form class="document-createmodal" method="post" name="user_add" id="user_add" action="<?php echo base_url(); ?>AdminSettings/createuser">
               <div class="modal-body">
                  <div class="card">
                     <div class="branch-items row mb-2">
                        <input type="hidden" name="update_id" value="<?php if (!empty($select_user->user_id)) {
                              ...
                              <?php foreach ($logtype_all as $val) {
                                 if ($val->logtype_name != "Admin") { ?>
                                    <option <?php if ($val->logtype_name == @$select_user->logtype) {
                                                echo "selected";
                                             } ?> value="<?php echo $val->logtype_id; ?>"><?php echo $val->logtype_name; ?></option>
                              <?php }
                              } ?>
                           </select>
                        </div>
                           ...
                           <?php foreach ($f_module as $key => $value) { ?>
                              ...
                              ?>
                                    <label for="pwd">
                                       ...
                                       <input type="checkbox" name="m_all[]" value="<?php echo $m->module_name; ?>" <?php if (isset($select_user->m_permission) && in_array($m->module_name, explode(",", $select_user->m_permission))) {
                                                                                                                        echo "checked";
                                                                                                                     } ?>>:
                                    </label>
                                    <br>
                                    ...
                                    ?>
                                          ...
                                          <label class="radio-inline">
                                             <input type="checkbox" name="f_all[]" value="<?php echo $l->name; ?>" <?php if (isset($select_user->permission) && in_array($l->name, explode(",", $select_user->permission))) {
                                                                                                                        echo "checked";
                                                                                                                     } ?>>Yes
                                          </label>
                                          <br>
