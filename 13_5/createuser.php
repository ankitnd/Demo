                        ...
                        <table class="table table-striped normal-table branch-table" id="table-1">
                           ...
                           <tbody>
                              <tr>  
                                 <td>Counselor</td>     
                                 <td>
                                    <strong>Name :</strong> RW1 Dhara Nadoda <br>
                                    <strong>Email :</strong> rnwdhara@gmail.com
                                </td> 
                                 <td>
                                 ...
                                 <td>2021-04-09 15:10:19</td>     
                                 <td><button type="btn" class="btn btn-primary btn-sm">Manage</button></td>    
                                 <td >Deactive</td>
                                 <td>
                                    <div class="dropdown">
