   ...
   function doc_upd(id) {
      ...
      $.ajax({
         ...
         success: function(resp) {
            ...
            var arr = f_permission.split(",");
            var arr1 = m_permission.split(",");
            var arr2 = permission.split(",");
...
<script type="text/javascript">
   ...
   //             //$('#m_parent_id').html(<option value=""></option>);
   //          }
   //       });
   //    });
   // });
...
<!-- Leads=1,New Enquiry=1,Today Report=1,Enquiry List=1,PendingFollowup=1,OverdueFollowup=1,View Demo=1,Course Details=1,Form=1,Last 6 Months=1,Current Month=1,Faculty Wise performance=1,Cancel Demo Reason wise=1,Place Type=1,Property Type=1,AddComplain New=1,View All Complain=1,Demo Report=1,Job Apply Application=1,View Stu Questions=1,View all jobs=1,View student applied on job=1,View Rapid Job=1,FaqView=1,TcShow=1,Group Create=1,show member=1,Add task=1,Observe Task=1,Working Task=1 -->