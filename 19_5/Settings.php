...
?>
    ...
    public function filter_department_wise()
    {
        ...
        foreach ($department as $dn) {
            ...
            if ($flag == 1) {
        ?>
                <option value="<?php echo $dn['department_id']; ?>" selected><?php echo $dn['department_name']; ?></option>
            <?php
            }
        }
    }
        ...
        <?php foreach ($f_module as $key => $value) { ?>
            <div class="form-group  col-md-4 col-sm-12">
                ...
                ?>
                        ...
                        <input type="checkbox" name="m_all[]" value="<?php echo $m->module_name; ?>" 
                        ...
                        ?>
                                ...
                                <label class="radio-inline">
                                    <input type="checkbox" name="f_all[]" value="<?php echo $l->name; ?>" 
