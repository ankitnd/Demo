...
?>
    ...
    public function fetch_permission_alll()
    {
        ...
        // echo "<pre>";
        // print_r(explode(",", $ldata['f_permission']));
        // print_r(isset($ldata['f_permission']) && in_array("CRM", explode(",", $ldata['f_permission'])) ? "TRUE" : "FALSE");
        // exit;
        ?>
        ...
        <?php foreach ($f_module as $key => $value) { ?>
            <div class="form-group  col-md-4 col-sm-12">
                <h6 class="text-dark">
                    ...
                    <input type="checkbox"  class="fp" id="<?php echo $value->f_module_name; ?>" name="fp[]" 
                ...
                ?>
                        <label class="ml-4 text-dark" for="pwd"><?php echo $m->module_name; ?> <input type="checkbox" name="m_all[]" value="<?php echo $m->module_name; ?>" <?php if (isset($ldata['m_permission']) && in_array($m->module_name, explode(",", $ldata['m_permission']))) {
                                                                                                                                                            echo "checked";
                                                                                                                                                        } ?>>:</label>
                        <br>
	...
	<table width='100%'>
        ...
        public function change_f_mod()
        {
            ...
            foreach ($data as $key => $value) { ?>
                <label class="ml-4 text-dark" for="pwd"><?php echo $value->module_name; ?> <input type="checkbox" name="m_all[]" value="<?php echo $value->module_name; ?>" onclick="l_chnage_mod(<?php echo $value->m_module_id; ?>)">:</label>
                <br>
