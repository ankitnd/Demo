...
<div class="col-md-8">
<input type="hidden" name="update_id" value="<?php if(!empty($select_subdepartment->subdepartment_id)) { echo $select_subdepartment->subdepartment_id; } ?>"/>
<?php if($_SESSION['logtype']=="Admin") { ?>

<div class="form-group">
<label for="email">SubDepartment Name:</label>
<input type="text" class="form-control" name="subdepartment_name" value="<?php if(!empty($select_subdepartment->subdepartment_name)) { echo $select_subdepartment->subdepartment_name; } ?>">
</div>
