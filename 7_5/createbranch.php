...
<div class="main-wrapper main-wrapper-1">
                        ...
                        <tr class="text-center">
                          <td class="p-0 text-center">
                            <div class="custom-checkbox custom-control">
                              <input type="checkbox" data-checkboxes="mygroup" class="custom-control-input" id="checkboxis-<?php echo $sno; ?>" name="branch_ids" value="<?php echo $val->branch_id; ?>">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <a 
                                  ...
                                  href="javascript:remove_doc(<?php echo $xx; ?>)" 
                                >
                                ...
                                <?php if ($val->branch_status == 0) { ?>
                                  <a 
                                    ...
                                    href="javascript:doc_status_upd(<?php echo $xx; ?>, 1)"
                                  >
                                ...
                                <?php } else {  ?>
                                  <a 
                                    class="dropdown-item has-icon" 
                                    href="javascript:doc_status_upd(<?php echo $xx; ?>, 0)"
                                  >
            ...
            <div class="card">
              <div class="branch-items row mb-2">
                <div class="form-group col-md-6 col-sm-12">
                  ...
                  <input  type="text" class="form-control" name="filter_branch" value="<?php if(!empty($filter_branch)) { echo @$filter_branch; } ?>" placeholder="Branch Name">
                </div>
                <div class="form-group col-md-6 col-sm-12">
                  <label for="">Mobile No 1 :</label>
                  <input name="mobile_one" id="mobile_one" type="text" name="filter_mobile_one" value="<?php if(!empty($filter_mobile_one)) { echo @$filter_mobile_one; } ?>" class="form-control" placeholder="Branch Mobile">
                </div>
                <div class="form-group  col-md-6 col-sm-12">
                  ...
                  <select class="form-control" name="admin_id" id="admin_id">
                    <option value="">Select Admin</option>
                    <?php foreach ($user_all as $val) { ?>
                      <option <?php if(@$filter_admin_id==$val->user_id) { echo "selected"; } ?> <?php if ($val->user_id == @$select_branch->admin_id) {
                                echo "selected";
                              } ?> value="<?php echo $val->user_id; ?>"><?php echo $val->name; ?></option>
                    <?php } ?>
                  </select>
                ...
                <div class="form-group col-md-6 col-sm-12">
                  ...
                  <input id="bank_name" type="text" class="form-control" name="bank_name" value="<?php if(!empty($filter_bank_name)) { echo @$filter_bank_name; } ?>">
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    function doc_status_upd(branch_id, status) {
      console.log(branch_id);
      $.ajax({
        url: "<?php echo base_url(); ?>AdminSettings/update_branch_status",
        type: "post",
        data: {
          'branch_id': branch_id,
          'status': status
    ...
    function remove_doc(branch_id) {
      ...
      if (conf) {
        $.ajax({
          url: "<?php echo base_url(); ?>AdminSettings/delete_branch_record",
          type: "post",
          data: {
            'branch_id': branch_id
          },
